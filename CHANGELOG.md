...
- Fixed auxiliary cover panels drawing stale menu-bar surfaces during system auto-hide retraction by deferring new cover creation until the retraction settles and auxiliary windows are re-scanned.
